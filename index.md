...
The application implements a simple CRUD application for managing "Contact", which is a Mongo Collection consisting of a name (String), an address (String), a description (String) and an owner.
